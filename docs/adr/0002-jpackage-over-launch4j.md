...
**Considered options**: keeping launch4j (tiny exe, but contradicts "self-contained" — users must install Java); GraalVM native-image (painful with desktop UI and reflection, no benefit at this app's size).
